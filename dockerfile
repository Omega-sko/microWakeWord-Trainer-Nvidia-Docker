...
RUN ln -s /root/mww-scripts/train_wake_word /usr/local/bin/train_wake_word && chmod +x /usr/local/bin/train_wake_word && \
    ln -s /root/mww-scripts/cli/wake_word_sample_trainer /usr/local/bin/wake_word_sample_trainer && chmod +x /usr/local/bin/wake_word_sample_trainer && \
    ln -s /root/mww-scripts/cli/wake_word_sample_generator /usr/local/bin/wake_word_sample_generator && chmod +x /usr/local/bin/wake_word_sample_generator && \
    ln -s /root/mww-scripts/cli/wake_word_sample_augmenter /usr/local/bin/wake_word_sample_augmenter && chmod +x /usr/local/bin/wake_word_sample_augmenter
