...
# Ensure train_wake_word is executable and create symlink in /usr/local/bin for system-wide availability
RUN chmod +x /root/mww-scripts/train_wake_word && \
    ln -s /root/mww-scripts/train_wake_word /usr/local/bin/train_wake_word
